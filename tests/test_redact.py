...
def Cfg(extra_terms=(), estate=None):
    """The config build_vocabulary/_estate read: the ES host, the operator's
    terms, the sources' index patterns and service domains, the estate."""
    return make_config(
        ...
        state_dir=STATE,
        research={"estate": estate or {"version": "19c"}})
